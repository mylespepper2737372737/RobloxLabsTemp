...
import { CheckDoesStringIncludeInvalidChars } from '../../../Util/CheckDoesStringIncludeInvalidChars';
import { CheckDoesStringIncludeProfanity } from '../../../Util/CheckDoesStringIncludeProfanity';
...
export namespace UsersService {
	export namespace Validators {
		function validateDoesUsernameContainProfanity(partialResponse: IServiceUsernameValidationResponse, response: Response) {
			if (CheckDoesStringIncludeProfanity(partialResponse.Username)) {
				response.send({
					...partialResponse,
		...
		function validateDoesUsernameContainInvalidChars(partialResponse: IServiceUsernameValidationResponse, response: Response) {
			if (CheckDoesStringIncludeInvalidChars(partialResponse.Username)) {
				response.send({
					...partialResponse,
		...
		function validateDoesUsernameContainWhiteSpace(partialResponse: IServiceUsernameValidationResponse, response: Response) {
			if (CheckDoesStringIncludeWhitespace(partialResponse.Username)) {
				response.send({
					...partialResponse,
