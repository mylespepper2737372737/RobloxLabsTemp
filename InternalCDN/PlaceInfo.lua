...
pcall(function() game:GetService("MarketplaceService"):SetProductInfoUrl("http://api.sitetest4.robloxlabs.com/marketplace/productinfo?assetId=%d") end)
pcall(function() game:GetService("MarketplaceService"):SetDevProductInfoUrl("http://api.sitetest4.robloxlabs.com/marketplace/productDetails?productId=%d") end)
