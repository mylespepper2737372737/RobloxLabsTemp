{
	...
	"Region": "eu-west-1",
	"Namespace": "default",
	"ID": "ActaDigitalServiceDevel",
	"ParentID": "",
	"Name": "ActaDigitalServiceDevel",
	"Type": "service",
	"Priority": 50,
	"AllAtOnce": false,
	"Datacenters": [
	...
	"TaskGroups": [
		{
			...
			"Tasks": [
				{
					"Name": "ActaDigitalService",
					"Driver": "exec",
					"User": "",
					"Config": {
						"command": "dotnet",
						"args": [
							"local/ActaDigitalService/ACBActaDigitalService.dll"
						]
					},
					"Env": {
						"RED_PORT": "6379",
					...
					"Artifacts": [
						{
							"GetterSource": "s3::https://s3-eu-west-1.amazonaws.com/acb-devel-pkf/DEV/API-DEVEL/ActaDigitalService_v0.5.7.tar.gz",
							"GetterOptions": {
	...
	"Stable": true,
	"Version": 242,
	"SubmitTime": 1621631682951314000,
	"CreateIndex": 96426,
	"ModifyIndex": 505976,
	"JobModifyIndex": 505896
}
