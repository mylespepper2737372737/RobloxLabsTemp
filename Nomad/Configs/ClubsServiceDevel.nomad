{
	...
	"Region": "eu-west-1",
	"Namespace": "default",
	"ID": "ClubsServiceDevel",
	"ParentID": "",
	"Name": "ClubsServiceDevel",
	"Type": "service",
	"Priority": 50,
	"AllAtOnce": false,
	"Datacenters": [
			...
			"Tasks": [
				{
					...
					"Config": {
						"args": [
							"local/ClubsService/ACBClubsService.dll"
						],
						"command": "dotnet"
					},
					"Env": {
					...
					"Artifacts": [
						{
							"GetterSource": "s3::https://s3-eu-west-1.amazonaws.com/acb-devel-pkf/DEV/API-DEVEL/ClubsService_v0.5.7.tar.gz",
							"GetterOptions": {
	...
	"Stable": true,
	"Version": 230,
	"SubmitTime": 1621631674682571300,
	"CreateIndex": 96397,
	"ModifyIndex": 505943,
	"JobModifyIndex": 505855
}
