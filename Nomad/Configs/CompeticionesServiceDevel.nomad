{
	...
	"Region": "eu-west-1",
	"Namespace": "default",
	"ID": "CompeticionesServiceDevel",
	"ParentID": "",
	"Name": "CompeticionesServiceDevel",
	"Type": "service",
	"Priority": 50,
	"AllAtOnce": false,
	"Datacenters": [
			...
			"Tasks": [
				{
					...
					"Config": {
						"command": "dotnet",
						"args": [
							"local/CompeticionService/ACBCompeticionService.dll"
						]
					},
					"Env": {
						"DB_USER": "acbdbcli",
					...
					"Artifacts": [
						{
							"GetterSource": "s3::https://s3-eu-west-1.amazonaws.com/acb-devel-pkf/DEV/API-DEVEL/CompeticionService_v0.5.7.tar.gz",
							"GetterOptions": {
	...
	"Stable": true,
	"Version": 288,
	"SubmitTime": 1621631676330400500,
	"CreateIndex": 96401,
	"ModifyIndex": 505963,
	"JobModifyIndex": 505863
}
