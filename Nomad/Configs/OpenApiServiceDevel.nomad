{
	...
	"Region": "eu-west-1",
	"Namespace": "default",
	"ID": "OpenApiServiceDevel",
	"ParentID": "",
	"Name": "OpenApiServiceDevel",
	"Type": "service",
	"Priority": 50,
	"AllAtOnce": false,
	"Datacenters": [
			...
			"Tasks": [
				{
					...
					"Config": {
						"args": [
							"local/OpenApiService/ACBOpenAPIService.dll"
						],
						"command": "dotnet"
					},
					"Env": {
						...
						"RED_WRITER_HOST": "redis-devel.acb.com",
						"RED_PORT": "6379",
					...
					"Artifacts": [
						{
							"GetterSource": "s3::https://s3-eu-west-1.amazonaws.com/acb-devel-pkf/DEV/API-DEVEL/OpenApiService_v0.5.7.tar.gz",
							"GetterOptions": {
	...
	"Stable": true,
	"Version": 224,
	"SubmitTime": 1621631685637994200,
	"CreateIndex": 182606,
	"ModifyIndex": 505960,
	"JobModifyIndex": 505907
}
