{
	...
	"Region": "eu-west-1",
	"Namespace": "default",
	"ID": "PersonasServiceDevel",
	"ParentID": "",
	"Name": "PersonasServiceDevel",
	"Type": "service",
	"Priority": 50,
	"AllAtOnce": false,
	"Datacenters": [
			...
			"Tasks": [
				{
					...
					"Artifacts": [
						{
							"GetterSource": "s3::https://s3-eu-west-1.amazonaws.com/acb-devel-pkf/DEV/API-DEVEL/PersonasService_v0.5.7.tar.gz",
							"GetterOptions": {
	...
	"Stable": true,
	"Version": 228,
	"SubmitTime": 1621631681866082000,
	"CreateIndex": 96423,
	"ModifyIndex": 505979,
	"JobModifyIndex": 505892
}
