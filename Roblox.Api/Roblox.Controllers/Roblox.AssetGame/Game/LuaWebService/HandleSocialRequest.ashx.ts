/*
	...
	File Type: Module
	Description: http://assetgame.sitetest4.robloxlabs.com/game/LuaWebService/HandleSocialRequest.ashx, Handles SocialRequests, such as checking if users are friends with each other.
