...
import { GetScopeForPersistentStore } from './Roblox.PersistentDataStores.GetHelpers.GetScopeForPersistentStore';
...
export const GetKeysOrEntriesForScope = (
	...
	return new Promise<[boolean, KeyType[] | null]>(async (resumefunction) => {
		...
		const dir2 = _dirname + '\\Roblox.Manifest\\persistence\\' + universeId + '\\stores\\' + name + '\\scopes\\' + scope;
