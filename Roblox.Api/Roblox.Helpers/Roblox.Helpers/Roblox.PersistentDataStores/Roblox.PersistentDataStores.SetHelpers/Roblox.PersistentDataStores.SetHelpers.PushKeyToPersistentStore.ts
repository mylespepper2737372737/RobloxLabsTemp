...
import { WriteUniverse } from './Roblox.PersistentDataStores.SetHelpers.WriteUniverse';
import { PushPersistentStoreToUniverse } from './Roblox.PersistentDataStores.SetHelpers.PushPersistentStoreToUniverse';
...
export const PushKeyToPersistentStore = (
	...
	return new Promise<boolean>(async (resumefunction) => {
		const path = _dirname + '\\Roblox.Manifest\\persistence\\' + universeId;
