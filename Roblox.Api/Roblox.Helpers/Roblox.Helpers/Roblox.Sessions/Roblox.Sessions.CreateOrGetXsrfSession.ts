...
import { CheckIfAuthTokenExists } from '../Roblox.Auth/Roblox.Api.Helpers.Auth.CheckIfAuthTokenExists';
...
export const CreateOrGetXsrfSession = (
	...
	const csrfSessions = filestream.readdirSync(_dirname + '\\Roblox.Manifest\\csrf');
