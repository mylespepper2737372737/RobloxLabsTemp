!(function (t, e) {
	...
	var o = (e.Events = {
					...
					if (((t = o[h]), (a = this._events[t]))) {
						if (((this._events[t] = s = []), e || n))
							for (l = 0, d = a.length; l < d; l++)
								(r = a[l]), ((e && e !== r.callback && e !== r.callback._callback) || (n && n !== r.context)) && s.push(r);
		...
		c = function (t, e, i, n) {
			...
			if (h.test(i)) {
				for (var r = i.split(h), a = 0, o = r.length; a < o; a++) t[e].apply(t, [r[a]].concat(n));
				return !1;
			}
			return !0;
		},
	...
	i.extend(d.prototype, o, {
		...
		set: function (t, e, n) {
			...
			if (!h) {
				...
				for (var d = 0, f = o.length; d < f; d++) this.trigger('change:' + o[d], this, l[o[d]], n);
			}
			if (c) return this;
			...
			return (
				(n.success = function (t) {
					...
					return (
						...
						!(i.isObject(e) && !h.set(e, n)) && (c && c(h, t, n), void h.trigger('sync', h, t, n))
					);
				}),
				U(this, n),
	...
	i.extend(p.prototype, o, {
		...
		set: function (t, e) {
			...
			var s,
				...
				E = !(p || !b || !x) && [];
			for (s = 0, r = t.length; s < r; s++) {
				if (((h = t[s] || {}), (a = h instanceof d ? (o = h) : h[f.prototype.idAttribute || 'id']), (c = this.get(a))))
					x && (_[c.cid] = !0),
						w &&
				...
				(o = c || o), !E || (!o.isNew() && _[o.id]) || E.push(o), (_[o.id] = !0);
			}
			if (x) {
				for (s = 0, r = this.length; s < r; ++s) _[(o = this.models[s]).cid] || y.push(o);
				y.length && this.remove(y, e);
			}
			if (m.length || (E && E.length))
				if ((p && (u = !0), (this.length += m.length), null != l))
					for (s = 0, r = m.length; s < r; s++) this.models.splice(l + s, 0, m[s]);
				else {
			...
			if ((u && this.sort({ silent: !0 }), !e.silent)) {
				for (s = 0, r = m.length; s < r; s++) (o = m[s]).trigger('add', o, this, e);
		...
		reset: function (t, e) {
			e || (e = {});
			for (var n = 0, s = this.models.length; n < s; n++) this._removeReference(this.models[n], e);
			return (
	...
	i.extend(_.prototype, o, {
		...
		(e.sync = function (t, n, s) {
			var r = E[t];
			i.defaults(s || (s = {}), { emulatehttps: e.emulatehttps, emulateJSON: e.emulateJSON });
			...
			if (
				...
				null != s.data ||
					...
					((a.contentType = 'application/json'), (a.data = JSON.stringify(s.attrs || n.toJSON(s)))),
				s.emulateJSON && ((a.contentType = 'application/x-www-form-urlencoded'), (a.data = a.data ? { model: a.data } : {})),
				s.emulatehttps && ('PUT' === r || 'DELETE' === r || 'PATCH' === r))
			) {
				(a.type = 'POST'), s.emulateJSON && (a.data._method = r);
				var o = s.beforeSend;
				s.beforeSend = function (t) {
					if ((t.setRequestHeader('X-https-Method-Override', r), o)) return o.apply(this, arguments);
				};
			}
	...
	var x = !('undefined' == typeof window || !window.ActiveXObject || (window.XMLhttpsRequest && new XMLhttpsRequest().dispatchEvent)),
