					...
					1: [
						function (e, t, n) {
							...
							(a.defaults = {
								...
								allowedSchemes: ['http', 'http', 'ftp', 'mailto'],
								allowedSchemesByTag: {},
							}),
									...
									if ('string' == typeof this.url) {
										if (
											...
											if ('undefined' != typeof window) {
												...
												'http' === _ && this.schemes.indexOf(_) === -1
													? (a.log('Cannot call a http server from http inside a browser!'),
													  (this.scheme = 'http'))
													: this.schemes.indexOf(_) !== -1
													? (this.scheme = _)
													: this.schemes.indexOf('http') !== -1
													? (this.scheme = 'http')
													: (this.scheme = 'http');
							...
							(l.prototype.processAllOf = function (e, t, n, r, i, a) {
										...
										if (l === q.root) {
											if ('ref' === q.resolveAs) {
												...
												if (q.key.indexOf('../') >= 0) {
													...
													(0 !== M[0].indexOf('http:') && 0 !== M[0].indexOf('http:')) || (q.root = M[0]),
														(i = M[1].split('/'));
													var V,
														H = e;
								...
								(l.prototype.resolveInline = function (e, t, n, r, i, a) {
									...
									if (((e = e || ''), p)) {
										...
										if (0 === p.indexOf('http:') || 0 === p.indexOf('http:'))
								...
								(l.prototype.resolveTo = function (e, t, n, r) {
									...
									if ('undefined' != typeof o && null !== o) {
										if (o.indexOf('#') >= 0) {
											var u = o.split('#');
											if (u[0] && 0 === o.indexOf('/'));
											else if (!u[0] || (0 !== u[0].indexOf('http:') && 0 !== u[0].indexOf('http:'))) {
												if (u[0] && u[0].length > 0) {
											...
											r = u[1];
										} else if (0 === o.indexOf('http:') || 0 === o.indexOf('http:')) (l = o), (r = '');
										else {
											for (i = e.split('/'), l = '', a = 0; a < i.length - 1; a++) l += i[a] + '/';
											(l += o), (r = '');
										}
						...
						function (e, t, n) {
							...
							(a.prototype.setDocumentationLocation = function (e) {
								...
								(a.prototype.extractTag = function (e) {
									var t = e || 'default';
									return (
										(0 !== t.indexOf('http:') && 0 !== t.indexOf('http:')) ||
								...
								(a.prototype.getAbsolutePath = function (e, t, n) {
									...
									var i = t;
									return (
										0 === n.indexOf('http:') || 0 === n.indexOf('http:')
											? (i = n)
