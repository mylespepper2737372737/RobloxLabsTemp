!(function (e) {
	...
	function c(e) {
		var r,
			...
			n,
			c = e.className + ' ';
		if (((c += e.parentNode ? e.parentNode.className : ''), (t = /\blang(?:uage)?-([\w-]+)\b/i.exec(c))))
				...
				for (var c = e.firstChild; c; c = c.nextSibling)
					3 == c.nodeType
						...
						: 1 == c.nodeType &&
						  ...
						  (a = n(c, a)),
						  t(c).match(/br|hr|img|input/) || r.push({ event: 'stop', offset: a, node: c }));
				return a;
			})(e, 0),
			r
		);
	...
	function l(e, t, a, c) {
		...
		function p() {
			...
			for (var n = M.lR.exec(B); n; ) {
				...
				var a = b(M, n);
				a ? ((L += a[1]), (e += g(a[0], r(n[0])))) : (e += r(n[0])), (t = M.lR.lastIndex), (n = M.lR.exec(B));
			}
		...
		function h() {
			...
			return M.r > 0 && (L += t.r), e && (R[M.sL] = t.top), g(t.language, t.value, !1, !0);
		}
		function d() {
		...
		function m(e, t) {
			var n = e.cN ? g(e.cN, '', !0) : '';
			e.rB ? ((x += n), (B = '')) : e.eB ? ((x += r(t) + n), (B = '')) : ((x += n), (B = t)),
		...
		function v(e, t) {
			...
			if (a) {
				...
				while (M != a.parent);
				return c.eE && (x += r(t)), (B = ''), a.starts && m(a.starts, ''), c.rE ? 0 : t.length;
			}
			if (s(t, M)) throw new Error('Illegal lexeme "' + t + '" for mode "' + (M.cN || '<unnamed>') + '"');
		...
		var B = '',
			L = 0;
		try {
			for (var S, A, k = 0; (M.t.lastIndex = k), (S = M.t.exec(t)), S; ) (A = v(t.substr(k, S.index - k), S[0])), (k = S.index + A);
			for (v(t.substr(k)), C = M; C.parent; C = C.parent) C.cN && (x += '</span>');
	...
	function p(e) {
		...
		if (!a(r)) {
			var t;
			w.useBR
				? ((t = document.createElementNS('https://www.w3.org/1999/xhtml', 'div')),
		...
		var r = '[A-Za-z0-9\\._:-]+',
			...
			n = {
				...
				c: [
					t,
					{ cN: 'attr', b: r, r: 0 },
					{ b: '=', r: 0, c: [{ cN: 'string', c: [t], v: [{ b: /"/, e: /"/ }, { b: /'/, e: /'/ }, { b: /[^\s\/>]+/ }] }] },
				],
			};
		return {
