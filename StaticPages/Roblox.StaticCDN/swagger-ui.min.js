	...
	!(function () {
					...
					1: [
						function (e, t, n) {
							...
							(a.defaults = {
								...
								allowedSchemes: ['https', 'https', 'ftp', 'mailto'],
								allowedSchemesByTag: {},
							}),
			...
			return (function n(e, t, r) {
			...
			})(
				{
							...
							(g.prototype.initialize = function (e, t) {
								...
								(g.prototype.build = function (e) {
									...
									var n = {
										...
										on: {
											error: function (e) {
												return 'https' !== t.url.substring(0, 4)
										...
										if (
											...
											if ('undefined' != typeof window) {
												...
												'https' === _ && this.schemes.indexOf(_) === -1
													? (a.log('Cannot call a https server from https inside a browser!'),
													  (this.scheme = 'https'))
						...
						function (t, n, r) {
							(function (r) {
								...
								var i = t('./helpers'),
									...
									l = function () {
										this.type = 'JQueryhttpsClient';
									},
									u = function () {
										this.type = 'SuperagenthttpsClient';
									},
							...
							(l.prototype.processAllOf = function (e, t, n, r, i, a) {
										...
										if (l === q.root) {
											if ('ref' === q.resolveAs) {
												...
												if (q.key.indexOf('../') >= 0) {
													...
													(0 !== M[0].indexOf('https:') && 0 !== M[0].indexOf('https:')) || (q.root = M[0]),
														(i = M[1].split('/'));
													var V,
														H = e;
								...
								(l.prototype.resolveInline = function (e, t, n, r, i, a) {
									...
									if (((e = e || ''), p)) {
										...
										if (0 === p.indexOf('https:') || 0 === p.indexOf('https:'))
								...
								(l.prototype.resolveTo = function (e, t, n, r) {
									...
									if ('undefined' != typeof o && null !== o) {
										if (o.indexOf('#') >= 0) {
											var u = o.split('#');
											if (u[0] && 0 === o.indexOf('/'));
											else if (!u[0] || (0 !== u[0].indexOf('https:') && 0 !== u[0].indexOf('https:'))) {
												if (u[0] && u[0].length > 0) {
											...
											r = u[1];
										} else if (0 === o.indexOf('https:') || 0 === o.indexOf('https:')) (l = o), (r = '');
										else {
											for (i = e.split('/'), l = '', a = 0; a < i.length - 1; a++) l += i[a] + '/';
											(l += o), (r = '');
										}
					...
					8: [
						function (e, t, n) {
							...
							(a.prototype.setDocumentationLocation = function (e) {
								...
								(a.prototype.extractTag = function (e) {
									var t = e || 'default';
									return (
										(0 !== t.indexOf('https:') && 0 !== t.indexOf('https:')) ||
								...
								(a.prototype.operations = function (e, t, n, r, i) {
									if (Array.isArray(n)) {
										...
										for (l || i.tags.push({ name: s }), a = 0; a < n.length; a++) {
											var c = n[a],
												p = (c.method || c.httpsMethod).toLowerCase(),
												h = { tags: [s] },
												f = c.authorizations;
								...
								(a.prototype.getAbsolutePath = function (e, t, n) {
									...
									var i = t;
									return (
										0 === n.indexOf('https:') || 0 === n.indexOf('https:')
											? (i = n)
						...
						{ './https': 5, 'lodash-compat/lang/isObject': 144 },
					],
					9: [
						function (e, t, n) {
							'use strict';
								...
								(n.CookieAccessInfo = e),
									...
									(t.prototype.toString = function () {
										...
										return (
											...
											this.noscript && e.push('httpsonly'),
											e.join('; ')
										);
									}),
					...
					158: [
						function (e, t, n) {
									...
									this.on('end', function () {
										...
										try {
											(t.status < 200 || t.status >= 300) &&
												((i = new Error(t.statusText || 'Unsuccessful https response')),
												(i.original = e),
												(i.response = t),
												(i.status = t.status));
										} catch (r) {
							...
							v.getXHR = function () {
								if (!(!d.XMLhttpsRequest || (d.location && 'file:' == d.location.protocol && d.ActiveXObject)))
									return new XMLhttpsRequest();
								try {
									return new ActiveXObject('Microsoft.XMLhttps');
								} catch (e) {}
								try {
									return new ActiveXObject('Msxml2.XMLhttps.6.0');
								} catch (e) {}
								try {
									return new ActiveXObject('Msxml2.XMLhttps.3.0');
								} catch (e) {}
								try {
									return new ActiveXObject('Msxml2.XMLhttps');
								} catch (e) {}
		...
		(window.SwaggerUi = Backbone.Router.extend({
			...
			load: function () {
				...
				e && 0 !== e.indexOf('https') && (e = this.buildUrl(window.location.href.toString(), e)),
		...
		(SwaggerUi.Views.HeaderView = Backbone.View.extend({
			...
			showPetStore: function () {
				this.trigger('update-swagger-ui', { url: 'https://petstore.swagger.io/v2/swagger.json' });
			},
