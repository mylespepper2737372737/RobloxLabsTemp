...
const SetCaptchaSessiontField_1 = __importDefault(require("../../modules/Helpers/SetCaptchaSessiontField"));
const crypto_1 = __importDefault(require("crypto"));
const GetCaptchaImages_1 = require("../../modules/Helpers/GetCaptchaImages");
...
const shuffleArray_1 = __importDefault(require("../../modules/Helpers/shuffleArray"));
...
exports.default = {
    ...
    func: (request, response) => {
        ...
        DeleteCaptchaSession_1.default(request.body['captchaHash']);
        setTimeout(() => {
            try {
        ...
        response
            ...
            .send({
            data: shuffleArray_1.default(images),
            captchaHash: newHash,
