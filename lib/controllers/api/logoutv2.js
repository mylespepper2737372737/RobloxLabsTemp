...
exports.default = {
    ...
    func: (request, response) => {
        ...
        fs_1.default.writeFile(directories_1._dirname + '/lib/env.json', JSON.stringify(data, undefined, 4), () => response.clearCookie('authId', { domain: '.sitetest1.mfdlabs.com', path: '/' }).send({ success: true, message: 'Success' }));
    },
};
