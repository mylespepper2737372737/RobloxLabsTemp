...
exports.default = {
    ...
    func: (request, response) => {
        ...
        if (!DFFlag['IsWWWAuthV1Enabled']) {
            Log_1.FASTLOG4(Log_1.FLog['WWWAuthV1'], 'The service is disabled currently.');
        ...
        if (FFlag['RequireGlobalHTTPS'] && request.protocol !== 'https') {
            Log_1.FASTLOG6(Log_1.FLog['WWWAuthV1'], 'HTTPS was not given where it was required.');
        ...
        if (DFFlag['IsCSRFV2Enabled']) {
            if (!request.headers['x-csrf-token'] ||
                ...
                if (DFFlag['IsCSRFV2Hardcoded']) {
                    Log_1.FASTLOG4(Log_1.FLog['WWWAuthV1'], FString['CSRFV2FailedResponseStatusText']);
                    return response
                        .status(403)
                        .header({
                ...
                Log_1.FASTLOG4(Log_1.FLog['WWWAuthV1'], 'Token Validation Failed.');
        ...
        if (!request.cookies['authId']) {
            Log_1.FASTLOG6(Log_1.FLog['WWWAuthV1'], 'AuthId did not exist on the request.');
        ...
        if (!isValidId) {
            Log_1.FASTLOG4(Log_1.FLog['WWWAuthV1'], `The user matching ${request.cookies['authId']} was not found.`);
        ...
        Log_1.FASTLOG1(Log_1.FLog['WWWAuthV1'], 'Request success, no issues.');
        return response
            .status(200)
