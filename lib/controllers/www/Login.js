...
const GetManifests_1 = __importDefault(require("../../modules/constants/GetManifests"));
const GetRegisteredUsers_1 = __importDefault(require("../../modules/constants/GetRegisteredUsers"));
...
exports.default = {
    ...
    func: (request, response) => {
        ...
        const Manifest = GetManifests_1.default();
