...
module.exports = (HttpServer, HttpsServer, opts) => {
    return new Promise((resolve, reject) => {
        ...
        if (opts.logSetups)
            console.log(`Mapping UPGRADE https://${opts.apiName}:5000`);
        ...
        if (opts.logSetups)
            console.log(`Mapping CONNECT https://${opts.apiName}:5000`);
        ...
        if (opts.logSetups)
            console.log(`Mapping UPGRADE http://${opts.apiName}:8000`);
        ...
        if (opts.logSetups)
            console.log(`Mapping CONNECT http://${opts.apiName}:8000`);
