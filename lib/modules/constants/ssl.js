...
module.exports = (app, name) => {
    try {
        spdy_1.default
            .createServer({
            cert: fs_1.default.readFileSync(directories_1._sslname + '\\sitetest1\\mfdlabs.crt', 'utf-8'),
            key: fs_1.default.readFileSync(directories_1._sslname + '\\sitetest1\\mfdlabsprivate.key', 'utf-8'),
