...
(async () => {
    ...
    (async () => {
        try {
            const [http, https] = ssl_1.default(images, urls_1.default['images']);
            await MapWebsockets_1.default(http, https, {
                path: directories_1._dirname + '\\lib\\sockets\\images',
                shouldHandleUpgrade: true,
                apiName: urls_1.default['images'],
                logSetups: true,
            });
