...
(async () => {
    ...
    await startup_1.default.Configure(mapconfig_1.default(staticcdn, '\\static\\sitetest1', '\\lib\\controllers\\static', urls_1.default['staticcdn']));
    await startup_1.default.Configure(mapconfig_1.default(js, '\\lib\\js\\sitetest1', '\\lib\\controllers\\js', urls_1.default['js']));
    await startup_1.default.Configure(mapconfig_1.default(css, '\\css\\sitetest1', '\\lib\\controllers\\css', urls_1.default['css']));
    await startup_1.default.Configure(mapconfig_1.default(images, '\\images\\sitetest1', '\\lib\\controllers\\images', urls_1.default['images']));
    await startup_1.default.Configure(mapconfig_1.default(api, '\\api\\sitetest1', '\\lib\\controllers\\api', urls_1.default['api']));
    await startup_1.default.Configure(mapconfig_1.default(setup, '\\setup\\sitetest1', '\\lib\\controllers\\setup', urls_1.default['setup']));
    await startup_1.default.Configure(mapconfig_1.default(www, '\\www\\sitetest1', '\\lib\\controllers\\www', urls_1.default['www'], true));
    await startup_1.default.Configure(mapconfig_1.default(ephemeralcounters, '\\ecs\\sitetest1', '\\lib\\controllers\\ecs', urls_1.default['ephemeralcounters']));
    ...
    (async () => {
        try {
            ...
            ssl_1.default(api, urls_1.default['api']);
