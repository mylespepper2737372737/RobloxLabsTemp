...
Log_1.LOGGROUP('ClientSettingsAPIV1');
...
(async function () {
    ...
    await startup_1.default.Configure(mapconfig_1.default(js, '\\dist', '\\lib\\controllers\\js', urls_1.default['js']));
...
function exitHandler(options, c) {
    if (options.exit) {
        Log_1.FASTLOG2(Log_1.FLog['Tasks'], 'Process exited with code' + typeof c === 'number' ? c.toString() : '1', true);
        process.exit();
    }
}
