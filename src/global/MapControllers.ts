...
// import { walk } from '../modules/Helpers/walk';
...
const MapControllers = (app?: IApplicationBuilder, opts?: EndpointOpts): Promise<void> => {
	return new Promise((r) => {
		...
		try {
			controllers = filestream.readdirSync(directory);
		} catch (err) {
			return FASTLOG6(FLog[opts.apiName], err);
		}
		// console.log(directory);
		// walk(directory + '\\', (e, r) => {
		// 	if (e) return FASTLOG6('Error', e.toString());
		// 	r.forEach((v) => {
		// 		// console.log(v);
		...
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping GET ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		// 						app.get('/' + name, func);
		// 					} else if (method === 'head') {
		// 						if (opts.logSetups)
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping HEAD ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		// 						app.head('/' + name, func);
		// 					} else if (method === 'post') {
		// 						if (opts.logSetups)
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping POST ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		// 						app.post('/' + name, func);
		// 					} else if (method === 'put') {
		// 						if (opts.logSetups)
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping PUT ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		// 						app.put('/' + name, func);
		...
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping DELETE ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		...
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping CONNECT ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		...
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping OPTIONS ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		...
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping TRACE ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		// 						app.trace('/' + name, func);
		...
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping PATCH ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		// 						app.patch('/' + name, func);
		// 					} else if (method === 'all') {
		// 						if (opts.logSetups)
		// 							FASTLOG3(
		// 								FLog[opts.apiName],
		// 								`Mapping ALL ${(opts.apiName ? 'https://' + opts.apiName : '') + '/' + name}`,
		// 							);
		// 						app.all('/' + name, func);
		// 					} else {
